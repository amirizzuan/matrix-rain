#!/usr/bin/env python3
#
# This is a fork from unimatrix.py.
# I have added so that when you run only "matrix-rain.py" without any
# argument parameters, it would simply run with the default
# argument of:
#        "-n -s 96 -l o".
#
# For me it is so annoying the original code does not have this defaulted
# properly.
# To run this, just run it using:
#         $ python matrix-rain.py
#
# The original source of this code is from the following:
# unimatrix.py
...
default_args = ['-n', '-s', '96', '-l', 'o']

# Apply default values if no arguments provided
import sys
if len(sys.argv) == 1:
